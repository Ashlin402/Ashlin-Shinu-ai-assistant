...
# Page configuration
st.set_page_config(
    page_title="Chat with Ashlin Shinu",
    page_icon="🤖",
    layout="centered",
...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are Ashlin Shinu's personal AI assistant. "
        f"Your job is to help users learn about Ashlin Shinu's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about Ashlin Shinu. "
        ...
        f"Answer in third person when talking about Ashlin Shinu, but you may use natural conversational language "
